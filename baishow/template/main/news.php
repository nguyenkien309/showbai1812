			...
			<div class="row"> 
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-latest-news">
						...
						<img width="350" height="250" src="<?php echo $base_url.$item['avatar'] ?>">
					</a>
						<div class="news-text-box">
							<h3><a href="single-news.html"> <?php echo $item['title']?></a></h3>
							<p class="blog-meta">
								<span class="author"><i class="fas fa-user"></i> <?php echo $item['author']?></span>
								<span class="date"><i class="fas fa-calendar"></i> <?php echo $item['created_at']?></span>
							</p>
							<p class="excerpt"><?php echo $item['content_text']?></p>
