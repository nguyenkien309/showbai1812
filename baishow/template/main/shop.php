...
<?php
	...
	// }
	$sql = "Select * from product where name='strawberry'";
	$sql2 = "Select * from product where name='berry'";
	$sql3 = "Select * from product where name='lemon'";
	$sql4 = "Select * from product where name='apple'";
	$sql6 = "Select * from product where name='banana'";
	$sql5 = "Select name from category";
	$product = $db->fetchAll($sql);
	$product2 = $db->fetchAll($sql2);
	$product3 = $db->fetchAll($sql3);
	$product4 = $db->fetchAll($sql4);
	$product5 = $db->fetchAll($sql6);
	$category = $db->fetchAll($sql5);
?>
<body>
                ...
                <div class="col-md-12">
                    <div class="product-filters">
                        <ul>
							...
							<li data-filter=".<?php echo $item['name']?>"><?php echo $item['name']?></li> 
                            <!-- <li data-filter=".strawberry">Strawberry</li>
                            <li data-filter=".berry">Berry</li> -->
							<!-- <a href="./shop.php?name=<?php echo $item['name']?>"><?php echo $item['name']?><a> -->
							<?php endforeach ?>
                        </ul>
                    </div>
                </div>
			...
			<div class="row product-lists">
				...
				<div class="col-lg-4 col-md-6 text-center strawberry">
					<div class="single-product-item">
						<div class="product-image">
							 ...
							 <img width="250" height="250" src="<?php echo $base_url.$item['avatar'] ?>" alt="">
							</a>
						</div>
						<h3><?php echo $item['name']?></h3>
						<p class="product-price"><span>Per Kg</span> <?php echo $item['price']?>$ </p>
						<a href="./cart.php?id=<?php echo $item['id']?>" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to Cart</a>
					</div>
				</div>
				<?php endforeach ?>
				...
				<div class="col-lg-4 col-md-6 text-center berry">
					<div class="single-product-item">
						...
						<h3><?php echo $item['name']?></h3>
						<p class="product-price"><span>Per Kg</span> <?php echo $item['price']?>$ </p>
						<a href="./single-product.php?id=<?php echo $item['id']?>" class="cart-btn"><i class="fas fa-shopping-cart"></i> Add to Cart</a>
					</div>
				</div>
				<?php endforeach ?>
				...
				<div class="col-lg-4 col-md-6 text-center apple">
					<div class="single-product-item">
						<div class="product-image">
							<a href="./single-product.php?id=<?php echo $item['id']?>">
							<img width="250" height="250" src="<?php echo $base_url.$item['avatar'] ?>" alt="">
				...
				<div class="col-lg-4 col-md-6 text-center banana">
					<div class="single-product-item">
						<div class="product-image">
							<a href="./single-product.php?id=<?php echo $item['id']?>">
							<img width="250" height="250" src="<?php echo $base_url.$item['avatar'] ?>" alt="">
				...
				<!-- <div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						<div class="product-image">
							<a href="single-product.html"><img src="../../public/site/temp2/img/products/product-img-4.jpg" alt=""></a>
						</div>
						<h3>Avocado</h3>
				...
				<div class="col-lg-4 col-md-6 text-center">
					<div class="single-product-item">
						<div class="product-image">
							<a href="single-product.html"><img src="../../public/site/temp2/img/products/product-img-5.jpg" alt=""></a>
						</div>
						<h3>Green Apple</h3>
				...
				<div class="col-lg-4 col-md-6 text-center strawberry">
					<div class="single-product-item">
						<div class="product-image">
							<a href="single-product.html"><img src="../../public/site/temp2/img/products/product-img-6.jpg" alt=""></a>
						</div>
						<h3>Strawberry</h3>
