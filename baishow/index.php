							...
							<ul>
								...
								<li><a href="#">Pages</a>
									<ul class="sub-menu">
										...
										<li><a href="./template/main/about.php">About</a></li>
										<li><a href="./template/main/cart.php">Cart</a></li>
										<li><a href="./template/main/checkout.php">Check Out</a></li>
										<li><a href="./template/main/contact.php">Contact</a></li>
										<li><a href="./template/main/news.php">News</a></li>
										<li><a href="./template/main/shop.php">Shop</a></li>
									</ul>
								</li>
								...
								<li><a href="./template/main/shop.php">Shop</a>
									<ul class="sub-menu">
        	...
        	<div class="row clearfix">
            	...
            	<div class="image-column col-lg-6">
                	<div class="image">
                    	...
                    	<img src="./public/site/temp2/img/a.jpg" alt="">
                    </div>
                </div>
                <!--Content Column-->
                <div class="content-column col-lg-6">
                    ...
                    <div class="time-counter">
						<div class="time-countdown clearfix" data-countdown="2020/2/01">
							<div class="counter-column"><div class="inner">
					...
					<div class="testimonial-sliders">
						<div class="single-testimonial-slider">
							<div class="client-avater">
								<img src="./public/site/temp2/img/avaters/avatar1.png" alt="">
							</div>
						...
						<div class="single-testimonial-slider">
							<div class="client-avater">
								<img src="./public/site/temp2/img/avaters/avatar2.png" alt="">
							</div>
							<div class="client-meta">
						...
						<div class="single-testimonial-slider">
							<div class="client-avater">
								<img src="./public/site/temp2/img/avaters/avatar3.png" alt="">
							</div>
							<div class="client-meta">
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<?php foreach($adslogo as $item) : ?>
						...
						<img width="250" height="200" src="<?php echo $base_url.$item['avatar'] ?>" alt="">	
						</div>
						<?php endforeach ?>
