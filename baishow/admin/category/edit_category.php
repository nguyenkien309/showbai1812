...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $data =
        [
          ...
          "total" => $_POST['origin'] ? $_POST['origin'] : '',
          "author_id" => $_POST['price'] ? $_POST['price'] : '',
        ];
    if($check){
        $data["avatar"] = "public/img/category/" . $file_name;
    }
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" required id="exampleInputPassword4" name="origin" value="<?php echo $product['total'] ?>" placeholder="Password">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword4">author_id</label>
                        <input type="text" class="form-control" required id="exampleInputPassword4" name="price" value="<?php echo $product['author_id'] ?>" placeholder="Password">
                      </div>
