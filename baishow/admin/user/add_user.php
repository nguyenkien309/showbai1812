                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" action="" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="password" id="exampleInputEmail3" placeholder="Email">
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="role" id="exampleInputName1" placeholder="Name">
                      </div>
